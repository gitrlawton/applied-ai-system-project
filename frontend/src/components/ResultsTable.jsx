...
const cellBase = { padding: "6px 8px", verticalAlign: "middle", lineHeight: "normal" };
      ...
      <TableBody>
        {results.map((song) => (
          <TableRow key={song.title}>
            <TableDataCell style={{ ...cellBase, textAlign: "center" }}>
              <MatchDot score={song.score} maxScore={maxScore} />
            </TableDataCell>
            <TableDataCell style={{ ...cellBase, maxWidth: 200, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
              {song.title} — {song.artist}
            </TableDataCell>
            <TableDataCell style={cellBase}>
            ...
            <TableDataCell style={{ ...cellBase, textAlign: "center" }}>{Math.round(song.tempo)}</TableDataCell>
            <TableDataCell style={{ ...cellBase, textAlign: "center" }}>{song.release_decade}</TableDataCell>
            <TableDataCell style={{ ...cellBase, maxWidth: 140, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
